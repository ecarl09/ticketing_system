    ...
    <div class="col-12">
        <div class="card mb-3 btn-reveal-trigger">
            <div class="card-header position-relative min-vh-25 mb-8">
                ...
                <form action="{{ route('update.profile.picture') }}" method="POST" enctype="multipart/form-data" id="uploadImage">
                    @csrf
        ...
        <div class="card mb-3">
            ...
            <div class="card-body bg-light">
                <div class="border rounded-1 position-relative bg-white dark__bg-1100 p-3">
                    ...
                    <form class="row g-3" action="{{ route('admin.update.account.submit') }}" id="update_user" method="POST">
                    @csrf
                        <div class="col-lg-4">
