                    ...
                    <div class="card-body overflow-hidden">
                        <div class="row justify-content-between align-items-center">
                            <div class="col">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-1 fs--1">
                                        <h5 class="fs-0">
                                            <a href="{{ route('events.details', $data->id) }}" style="text-transform: capitalize; ">
                                                {{$data->title}}
                                            </a>
                                        </h5>
                                        <p class="mb-0">
                            ...
                            <div class="col-md-auto d-none d-md-block">
                                <a href="{{ route('events.details', $data->id) }}" class="btn btn-primary btn-sm px-4" type="button">View Details</a>
                            </div>
                        </div>
                    </div>
                </div>
            @else
                <div class="card mb-3">
                            ...
                            <div class="col">
                                <div class="d-flex">
                                    <div class="flex-1 align-self-center">
                                        <p class="mb-1 lh-1">
                                            <a class="fw-semi-bold" href="{{ route('news.details', $data->id) }}">{{$data->title}}</a>
                                        </p>
                    ...
                    <div class="card-body overflow-hidden pt-0">
                        ...
                        <a class="fs--1 d-inline-block mt-0 link-primary" href="{{ route('news.details', $data->id) }}">Read more</a>
                    </div>
                </div>
            @endif
        @endforeach  
