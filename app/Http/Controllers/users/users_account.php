...
class users_account extends Controller{

    public function account(){
        $data = User::find(Auth::user()['id']);
        return view('users/user_account', ['user' => $data]);
    }

    // public function get_user_details_to_update(){
    //     $data = User::find(Auth::user()['id']);
    //     return view('users/user_account_update', ['user' => $data]);
    // }
    ...
    public function update_user_account_form(Request $value){
        ...
        return redirect()->action([users_account::class, 'account']);
    }

    public function update_password(){
        return view('users/user_update_password');
    }
    ...
    public function uploadUserProfile(Request $value){
